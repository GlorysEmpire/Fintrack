...
/**
 * LOGIN — aurora + glass + floating particles (UI PR6).
 */
    ...
    <AuroraBackground>
      ...
      <div className="container relative z-10 mx-auto flex min-h-screen max-w-md flex-col justify-center px-6 py-12">
        ...
        >
          ...
          <h1 className="font-display text-4xl font-normal leading-tight tracking-tight sm:text-5xl">
            Your money.
            <br />
            Your rules.
          </h1>
          ...
          <motion.div
            layout
            className="glass-card mt-8 rounded-[1.5rem] p-5 sm:p-6"
