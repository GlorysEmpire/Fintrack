...
export function AuroraBackground({
  ...
  return (
    <div
      className={cn(
        "relative min-h-screen overflow-hidden bg-[oklch(0.12_0.02_160)] text-foreground",
        className
      )}
    >
      <div
        aria-hidden
        className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_20%_20%,oklch(0.35_0.12_160/0.45),transparent_55%),radial-gradient(ellipse_at_80%_10%,oklch(0.32_0.14_280/0.4),transparent_50%),radial-gradient(ellipse_at_50%_90%,oklch(0.28_0.12_310/0.35),transparent_55%)]"
      />
      <div
        aria-hidden
